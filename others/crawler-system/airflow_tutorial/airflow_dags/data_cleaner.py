def data_cleaner():
    ...
    df = pd.read_csv("/store_files/raw_store_transactions.csv")

    def clean_store_location(st_loc):
        # match non-character and space, then delete them
    ...
    df.to_csv("/store_files/clean_store_transactions.csv", index=False)
